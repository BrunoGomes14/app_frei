...
public class DialogAvisoSucesso extends Dialog
{
    private TextView lblAvisoTexto;
    private LinearLayout btnOk;

    public DialogAvisoSucesso(@NonNull Context contextParam, String sAvisoParam)
    {
        super(contextParam);
    ...
    public DialogAvisoSucesso(@NonNull Context contextParam, String sAvisoParam, Activity contextAc)
    {
        super(contextParam);
    ...
    public void definePadroes()
    {
        ...
        setContentView(R.layout.dlg_aviso_sucesso);
        setCancelable(true);
